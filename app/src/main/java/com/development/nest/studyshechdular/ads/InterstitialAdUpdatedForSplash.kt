...
open class InterstitialAdUpdatedForSplash {

    var mInterstitialAd: InterstitialAd? = null

    companion object {
        @Volatile
        private var instance: InterstitialAdUpdatedForSplash? = null
        fun getInstance() = instance ?: synchronized(this) {
            instance ?: InterstitialAdUpdatedForSplash().also { instance = it }
        }
...
//                loadInterstitialAd(context)
                ...
                InterstitialAdUpdated.getInstance().loadInterstitialAd(context)
                isInterstitialShown = false
                afterAdWork()
            }
